---
INTENT: Week 1 Authority Campaign — complete social media content package ready for Saia review and publish.
type: content_package
status: DRAFT — ⏸ PAUSED — AWAITING SAIA REVIEW + Airtable AI_CONTENT_APPROVED toggle
week: 1
theme: Establish Authority — "Damage You Can't See From the Driveway"
architect: M7 VP Marketing (Claude Code)
generated: 2026-06-30
campaign_ref: M7_INTEGRATED_CAMPAIGN.md Section 3, Week 1
airtable_gate: fldsiqiBn63Dt1Scz → AI_CONTENT_APPROVED must = TRUE before any post goes live
target_zips: 75033, 75034, 75035 (Frisco Core)
segments: Property Managers (Tue–Thu 7–9 AM) · Luxury Estates
---

# WEEK 1 AUTHORITY CAMPAIGN — CONTENT PACKAGE
> **Outbox Shield Active.** Nothing goes live until Saia toggles AI_CONTENT_APPROVED in Airtable and manually sets publish date.

---

## CONTENT STRATEGY: Week 1 → Establish Authority
**Goal:** Warm Frisco property managers + luxury homeowners with proof-of-expertise.
**Lead angle:** Damage that stays hidden until it's too late (drone reveal hook).
**Cadence:** 4 posts across the week (Tue/Thu/Sat social, Wed GBP).

---

## POST 1 — INSTAGRAM/FACEBOOK REEL (Tuesday, post 7:00 AM CT)
**Format:** Drone reveal video + voiceover
**Pillar:** Authority
**Segment:** Property Managers

### Hook (Gold text overlay, first 0.3s)
> "Your roof has damage you can't see from the driveway."

### Voiceover Script (0:00–0:30)
...
## POST 2 — BEFORE/AFTER CAROUSEL (Thursday, post 7:30 AM CT)
**Format:** 5-slide carousel
**Pillar:** Proof
**Segment:** Luxury Estates (Starwood, Stonebriar)

### Slide 1 (Hook — Gold text on Navy)
**Headline:** "Same Storm. Two Houses. One Filed Their Claim In Time."

### Slide 2 (Before)
**Overlay:** "BEFORE — What the naked eye sees"
**Caption on slide:** "Driveway inspection: nothing visible. Adjuster initial estimate: $4,200."
...
### Slide 4 (After)
**Overlay:** "AFTER — Full Restoration Coverage Evaluation approved"
...
One homeowner called us within 72 hours. The other waited and let the evidence degrade.

The difference?
▸ Home A: $34,700 full restoration. IKO Certified materials. Done in 4 days.
▸ Home B: Denied claim. Out-of-pocket costs. Still not restored.
...
— Fakakoloa 'ae fononga 'aki 'ae 'aho kotoa. (Enrich the journey with every day.)

#PineappleContractors #FriscoRoofing #HailDamage #InsuranceClaim #BeforeAndAfter #RoofRestoration #IKOCertified #RCAT"

---

## POST 3 — HERITAGE STORY VIDEO (Saturday, post 10:00 AM CT)
**Format:** 60-second talking-head or family B-roll
**Pillar:** Heritage
**Segment:** Broad (both — highest organic reach driver)

### Script
> "My name is Saia Tatafu. I started Pineapple Contractors in 2005 with one truck and a belief my grandfather taught me growing up in Tonga — Tauhi Vā. It means nurturing the space between people. Taking care of the relationship, not just the transaction.
>
> Twenty years later, we've restored over 350 properties across Frisco. My crew treats every roof like it's our grandmother's house. We're RCAT licensed, IKO certified, and we've earned every one of our 5-star reviews the hard way — one family at a time.
>
...
21 years ago, I started Pineapple Contractors with one truck and my grandfather's words: *Tauhi Vā* — nurture the relationship between people.

Today, our crew has restored 350+ homes across Frisco. RCAT Licensed #03-0637. IKO Certified. 5-Star rated. Still Polynesian-owned, still family-operated.
...
#PineappleContractors #PolynesiаnOwned #FriscoRoofing #TauhiVa #FamilyBusiness #IKOCertified #FriscoTX #RoofingContractor"

---

## POST 4 — GOOGLE BUSINESS PROFILE (Wednesday, post 8:00 AM CT)
**Format:** GBP Post — What's New
...
• Full damage report formatted for insurance submission
...
RCAT License #03-0637 · IKO Certified RoofPro Team"

### CTA Button: "Call Now" → 972-928-0788

---

## META AD SCRIPTS — 3-ANGLE HORMOZI MATRIX
> These are pre-written for Saia to review. Load into Meta Ads Manager as DRAFT PAUSED.

### Angle 1: Insurance Deadline Hook
**Headline:** "Frisco — Your 30-Day Claim Window Is Closing"
**Primary Text:**
"Most Frisco homeowners don't know they have 30 days from the storm date to document damage before evidence degrades.

After that window, even valid claims get denied.
...
**Status:** ⏸ PAUSED — Saia launches

---

### Angle 2: Stress-Free Claim
**Headline:** "No Sales Pressure. Just Engineering Documentation."
**Primary Text:**
"Here's the truth about most roof inspections: they're sales appointments disguised as help.
...
**Targeting:** Frisco TX, homeowners 40–70, high-income ($150K+), property concern signals
**Status:** ⏸ PAUSED — Saia launches

---

### Angle 3: Local Trust / Heritage
**Headline:** "350+ Frisco Families. Polynesian Heritage. RCAT Licensed."
**Primary Text:**
"Saia Tatafu started Pineapple Contractors in 2005 with a belief his grandfather taught him — Tauhi Vā. Nurture the relationship, not just the transaction.

Twenty-one years later, we're Frisco's most trusted storm restoration team.

Not because we're the biggest.
Because we treat every roof like our grandmother's house.
...
**Call-to-Action:** Book Now
**Targeting:** Frisco TX, broad 30–65, Polynesian community affinity + homeowners
**Status:** ⏸ PAUSED — Saia launches

---

## WEEKLY LSA/GBP CHECKLIST (run every Monday)
- [ ] Reply to all open LSA leads (< 5 minutes; see M7_LEAD_ENGINE.md speed-to-lead SLA)
- [ ] Dispute any bad-fit leads in LSA console for credits
- [ ] Publish Wednesday GBP post above
- [ ] Request review from last week's completed jobs (link + template in M7_LEAD_ENGINE.md)
- [ ] Log all leads in CRM → Google_LSA_Leads tab
- [ ] Pull LSA performance report (cost per signed job)
...
- [x] No "warrior/toa/six brothers" in customer-facing copy ✓
- [x] All ads: ⏸ PAUSED ✓
- [x] Tongan proverbs included ✓
- [x] 10px Navy border on photos noted in visual direction ✓
