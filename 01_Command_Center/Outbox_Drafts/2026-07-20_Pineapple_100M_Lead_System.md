...
**A "lead" = one person who raises their hand and says "look at my roof."** Your job is to get more hands up.
There are only **4 doors** leads come through. That's it. Here they are, easiest first.

---

## 🚪 THE 4 DOORS (where every lead comes from)

### Door 1 — WARM (people who already know you) 🟢 easiest, cheapest
These are past customers, their neighbors, your friends, church, family, property managers you've met.
They already trust you, so they say yes fastest.
- **Do:** text every past customer for a review + ask "know a neighbor whose roof got hit?"
- **Do:** when you finish a job, knock the 10 closest houses — "we just did your neighbor's roof."
- **Leads/day:** 2–5 with almost no effort. **Cost:** free (just your time).
...
> Why these 2: one uses the thing you're already elite at (knocking), the other costs $0 and compounds.
> Ads (Door 4) come later once the offer + form are proven — don't pay for traffic before the funnel works.

---

## 🛠️ THE EXECUTION PLAN (what to actually do each week)
| Day | Do this |
|-----|---------|
...
| **Every day** | **Answer every new lead in 5 minutes.** (This one habit doubles your bookings.) |

---

## 📋 THE OUTPUT (what you'll have when it's running)
- A **full pipeline**: ~100 hands up a month, all landing in your CRM `Google_LSA_Leads` tab.
- Each lead **scored** (80+ = call today, 60–79 = this week, <60 = nurture).
- A **content machine** (reels) that keeps producing leads without more knocking.
- A **number you can trust**: cost per *signed job* (not clicks) — so you know exactly what's working.

---

## 🔁 THE WORKFLOW (how a lead becomes money)
```
...
Show the damage (proof)  →  We handle the insurance claim  →  New roof, homeowner pays deductible
        │
        ▼
Job done  →  ask for the review + a before/after clip  →  that clip becomes next week's reel
