...
## The one-sentence offer (jaw-dropper)
**"We map your storm damage with a drone + ground audit, build your claim-ready file, and restore your roof
through your insurance — so you get a new IKO Certified roof for the cost of your deductible, and if there's
no documentable damage, you owe nothing and keep the report."**

## 🧬 The unique mechanism
**The Documentation-First Roof Rescue™** — *Show. Don't sell. Prove.*
(Problem → Proof → Path. We win claims with evidence, not opinions.)
...
| 5 | **Final inspection + warranty registration** — done right, documented | $250 |

## 🎁 5 bonuses (make perceived value 10x)
1. **24-Hour Storm Response Priority** — you jump the line after a named storm.
2. **Denied-Claim Reopen Service** — already told no? We re-document and reopen it.
3. **The Homeowner Claim Playbook (PDF)** — exactly what to say to your insurer.
4. **Full Restoration Coverage handling** — we manage the claim so your out-of-pocket is just your deductible.
...
## 🛡️ The guarantee (risk reversal — truthful)
**"The Keep-the-Report Guarantee:** If we don't find documentable storm damage, you owe nothing and you keep
the full audit report. And if your approved scope isn't installed to IKO specification, we make it right — or
you don't pay for the workmanship."
*(We never guarantee claim approval — we guarantee documentation and workmanship. That's honest and it still
removes the fear.)*
