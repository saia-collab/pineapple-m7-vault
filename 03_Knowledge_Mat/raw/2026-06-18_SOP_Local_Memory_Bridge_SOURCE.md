...
* **Offer Standardization:** Replace all instances of "Free Inspection" or "Free Estimate" with **Complimentary Professional Photo Audit (CPPA)**.  
* **Financial Authority:** "$0 Down" or "$0 Out of Pocket" must be rewritten as **Full Restoration Coverage**.
...
| **Permissions:** Read-only for AI agents unless explicitly commanded to append something [08:13 Opens in a new window](http://www.youtube.com/watch?v=eIXheJcxDIg&t=493) . | **Permissions:** AI is free to write, organize, and execute code within this directory [08:23 Opens in a new window](http://www.youtube.com/watch?v=eIXheJcxDIg&t=503) . |
