# 20 · Agent Kanban (Optional — Complimentary, 100% local)

Watch a little team of AI agents work a live board for you. You give it a goal; it fills a kanban board and builds each card — all on your own machine, Complimentary, no keys.
...
## What you need
Just the **Complimentary local builder** — the same Ollama setup from `2-VOICE-BUILDING.md`:
...
## Good to know
- **Complimentary + private.** Nothing leaves your machine; it uses your local model.
...
## Done?
This shares the Complimentary local engine with **`2-VOICE-BUILDING.md`** and the **Pipeline**. For the big picture of which model does what, see **`0-HOW-IT-ALL-WORKS.md`**.
