...
This is the magic one. You say **"build me a snake game"** and a real, working game appears on your screen in about 15 seconds. It runs on your **own computer**, so it's **Complimentary** and **private** — no monthly cost, no sending your stuff to the cloud.

## What you get
The **Complimentary Claude Code → Agent Factory** tab. Type or speak an idea, and a small AI on your machine builds it. Games, animations, tools — single web pages that just open and play.

## What you need
A Complimentary app called **Ollama** that runs AI on your computer, and one model (the "brain"). About 5 minutes, one time.
...
2. Click **Complimentary Claude Code** on the left → the **Agent Factory** tab.
3. Type **"build me a colorful starfield"** and hit Build.
4. Watch it write the code on the left, then run on the right. 🎉

## Good to know
- **It's Complimentary, every time.** The building happens on your machine. No bill, ever.
