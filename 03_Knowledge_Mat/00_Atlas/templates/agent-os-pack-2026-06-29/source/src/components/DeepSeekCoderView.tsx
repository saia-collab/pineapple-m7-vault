      ...
      <div className="relative overflow-hidden rounded-2xl border p-5" style={{ borderColor: "var(--panel-border)", background: "rgba(255,255,255,0.02)" }}>
        ...
        <div className="relative">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[10px] uppercase tracking-[0.2em] flex items-center gap-1.5" style={{ color: ACCENT }}><Sparkles size={11} /> DeepSeek V4 · Official API · Live</div>
              <div className="text-[19px] font-semibold text-[var(--cream)] leading-tight">DeepSeek Coder</div>
            </div>
          ...
          <p className="text-[13px] text-[var(--cream-soft)] mt-3 leading-relaxed max-w-[660px]">
            <b className="text-[var(--cream)]">DeepSeek V4</b>, straight off DeepSeek&apos;s own API — the 0731 build with the agent upgrade. Type a prompt, watch it build <b className="text-[var(--cream)]">live on the right</b>. Builds and chat history both survive a refresh.
          </p>
